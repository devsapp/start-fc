# Alibaba Cloud Function Compute Node.js10 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-node.js10/src)
...
- Initialize the project: `s init start-fc-http-nodejs10 -d start-fc-http-nodejs10`
...
- Enter the project: `cd start-fc-http-nodejs10`
