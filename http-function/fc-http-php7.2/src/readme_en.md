# Alibaba Cloud Function Compute PHP7.2 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-php7.2/src)
...
- Initialize the project: `s init start-fc-http-php7 -d start-fc-http-php7`
...
- Enter the project: `cd start-fc-http-php7`
