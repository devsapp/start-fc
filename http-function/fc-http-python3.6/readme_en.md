# Alibaba Cloud Function Compute Python3.6 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-python3.6/src)
...
- Initialize the project: `s init start-fc-http-python3 -d start-fc-http-python3`
...
- Enter the project: `cd start-fc-http-python3`
