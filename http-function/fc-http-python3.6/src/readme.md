...
- [😼 源代码](https://github.com/devsapp/start-fc/blob/main/http-function/fc-http-python3.6)
...
- 🔥 通过 [Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=start-fc-http-python3) ，
