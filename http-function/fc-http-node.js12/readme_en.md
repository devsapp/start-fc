# Alibaba Cloud Function Compute Node.js12 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-node.js12/src)
...
- Initialize the project: `s init start-fc-http-nodejs12 -d start-fc-http-nodejs12`
...
- Enter the project: `cd start-fc-http-nodejs12`
