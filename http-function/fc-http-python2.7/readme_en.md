# Alibaba Cloud Function Compute Python2.7 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-python2.7/src)
...
- Initialize the project: `s init start-fc-http-python2 -d start-fc-http-python2`
...
- Enter the project: `cd start-fc-http-python2`
