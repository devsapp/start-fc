# 快速体验 Python2.7 HTTP 函数案例

欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Python2.7 HTTP 案例到阿里云函数计算。
...
```
s init start-fc-http-python2 -d start-fc-http-python2
```
