# Alibaba Cloud Function Compute Node.js6 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-node.js6/src)
...
- Initialize the project: `s init start-fc-http-nodejs6 -d start-fc-http-nodejs6`
...
- Enter the project: `cd start-fc-http-nodejs6`
