# 快速体验 Node.js8 HTTP 函数案例

欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Node.js8 HTTP 案例到阿里云函数计算。
...
```
s init start-fc-http-nodejs8 -d start-fc-http-nodejs8
```
