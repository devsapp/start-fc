# Alibaba Cloud Function Compute Node.js8 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/http-function/fc-http-node.js8/src)
...
- Initialize the project: `s init start-fc-http-nodejs8 -d start-fc-http-nodejs8`
...
- Enter the project: `cd start-fc-http-nodejs8`
