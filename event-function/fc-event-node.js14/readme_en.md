# Alibaba Cloud Function Compute Node.js14 Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/event-function/fc-event-node.js14/src)
...
- Initialize the project: `s init start-fc-event-nodejs14 -d start-fc-event-nodejs14`
...
- Enter the project: `cd start-fc-event-nodejs14`
