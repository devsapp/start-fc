...
- [😼 源代码](https://github.com/devsapp/start-fc/blob/main/event-function/fc-event-node.js14)
...
- 🔥 通过 [Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=start-fc-event-nodejs14) ，
