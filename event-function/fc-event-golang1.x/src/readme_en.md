# Alibaba Cloud Function Compute Golang1.x Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/event-function/fc-event-golang1.x/src)
...
- Initialize the project: `s init start-fc-event-golang1.x -d start-fc-event-golang1.x`
...
- Enter the project: `cd start-fc-event-golang1.x`
