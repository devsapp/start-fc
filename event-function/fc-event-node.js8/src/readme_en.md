# Alibaba Cloud Function Compute Node.js8 Event function case
...
- Initialize the project: `s init start-fc-event-nodejs8 -d start-fc-event-nodejs8`
...
- Enter the project: `cd start-fc-event-nodejs8`
