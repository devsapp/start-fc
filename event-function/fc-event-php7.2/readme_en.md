# Alibaba Cloud Function Compute PHP7.2 Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/event-function/fc-event-php7.2/src)
...
- Initialize the project: `s init start-fc-event-php7 -d start-fc-event-php7`
...
- Enter the project: `cd start-fc-event-php7`
