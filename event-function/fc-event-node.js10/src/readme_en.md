# Alibaba Cloud Function Compute Node.js10 Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/event-function/fc-event-node.js10/src)
...
- Initialize the project: `s init start-fc-event-nodejs10 -d start-fc-event-nodejs10`
...
- Enter the project: `cd start-fc-event-nodejs10`
