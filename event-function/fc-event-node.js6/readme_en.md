# Alibaba Cloud Function Compute Node.js6 Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/event-function/fc-event-node.js6/src)
...
- Initialize the project: `s init start-fc-event-nodejs6 -d start-fc-event-nodejs6`
...
- Enter the project: `cd start-fc-event-nodejs6`
