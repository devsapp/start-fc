# Alibaba Cloud Function Compute Python2.7 Event function case
...
- Initialize the project: `s init start-fc-event-python2 -d start-fc-event-python2`
...
- Enter the project: `cd start-fc-event-python2`
