# Alibaba Cloud Function Compute Custom Container Springboot function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-container-function/fc-custom-container-http-springboot/src)
...
- Initialize the project: `s init start-fc-custom-container-http-springboot -d start-cc-springboot`
...
- Enter the project: `cd start-cc-springboot`
