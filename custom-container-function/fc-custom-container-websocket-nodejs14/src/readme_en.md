# Alibaba Cloud Function Compute Custom Container Node.js14 Websocket function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-container-function/fc-custom-container-websocket-nodejs14/src)
...
- Initialize the project: `s init start-fc-custom-container-websocket-nodejs14 -d start-cc-nodejs14-websocket`
...
- Enter the project: `cd start-cc-nodejs14-websocket`
