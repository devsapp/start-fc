# Alibaba Cloud Function Compute Custom Container Golang Websocket function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-container-function/fc-custom-container-websocket-golang/src)
...
- Initialize the project: `s init start-fc-custom-container-websocket-golang -d start-cc-golang-websocket`
...
- Enter the project: `cd start-cc-golang-websocket`
