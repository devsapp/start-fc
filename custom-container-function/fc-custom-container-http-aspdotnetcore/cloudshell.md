# 快速体验 Custom Container ASP.NET Core HTTP 函数案例

欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Custom Container ASP.NET Core HTTP 案例到阿里云函数计算。
...
```
s init start-fc-custom-container-http-aspdotnetcore -d start-cc-aspdotnetcore-http
```
