# Alibaba Cloud Function Compute Custom Container Python3.9 Websocket function case
...
- Initialize the project: `s init start-fc-custom-container-websocket-python3.9 -d start-cc-python39-websocket`
...
- Enter the project: `cd start-cc-python39-websocket`
