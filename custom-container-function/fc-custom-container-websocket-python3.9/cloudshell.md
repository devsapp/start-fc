# 快速体验 Custom Container Python3.9 Websocket 函数案例

欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Custom Container Python3.9 Websocket 案例到阿里云函数计算。
...
```
s init start-fc-custom-container-websocket-python3.9 -d start-cc-python39-websocket
```
