...
- [:smiley_cat: 代码](https://code.alibaba-inc.com/serverless-devs/start-fc/tree/master/custom-container/nodejs)
...
- 通过 [Serverless Devs Cli](https://www.serverless-devs.com/serverless-devs/install) 进行部署：
  ...
  - 初始化项目：`s init --project start-fc3-custom-container-nodejs -d start-fc3-custom-container-nodejs`
