...
快速部署一个 Node.JS 通过临时密钥安全读写 OSS 的资源函数到阿里云函数计算。

</description>

<codeUrl>

- [:smiley_cat: 代码](https://github.com/devsapp/start-fc/tree/main/fc-node/oss-event/src)
...
- 通过 [Serverless Devs Cli](https://www.serverless-devs.com/serverless-devs/install) 进行部署：
  ...
  - 初始化项目：`s init start-fc3-nodejs-oss -d start-fc3-nodejs-oss`
