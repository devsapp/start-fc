# Alibaba Cloud Function Compute Typescript Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/typescript/fc-custom-typescript-event/src)
...
- Initialize the project: `s init fc-custom-typescript-event -d fc-custom-typescript-event`
...
- Enter the project: `cd fc-custom-typescript-event`
