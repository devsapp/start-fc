# Alibaba Cloud Function Compute Ruby Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/ruby/fc-custom-ruby-event/src)
