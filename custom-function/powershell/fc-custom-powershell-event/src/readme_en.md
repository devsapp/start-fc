# Alibaba Cloud Function Compute Powershell Event function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/powershell/fc-custom-powershell-event/src)
...
- Initialize the project: `s init fc-custom-powershell-event -d fc-custom-powershell-event`
...
- Enter the project: `cd fc-custom-powershell-event`
