# 快速体验 Java8 HTTP 函数案例

欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Java8 HTTP 案例到阿里云函数计算。
...
> - [:octocat: 源代码](https://github.com/devsapp/start-fc/tree/main/custom-function/java8/fc-custom-java17-http/src)
...
```
s init fc-custom-java17-http -d fc-custom-java17-http
```
