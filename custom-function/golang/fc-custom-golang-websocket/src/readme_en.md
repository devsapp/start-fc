# Alibaba Cloud Function Compute Golang Websocket function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/golang/fc-custom-golang-websocket/src)
