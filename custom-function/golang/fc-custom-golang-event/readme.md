...
- [😼 源代码](https://github.com/devsapp/start-fc/blob/main/custom-function/golang/fc-custom-golang-event)
...
- 🔥 通过 [Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=fc-custom-golang-event) ，
