# Alibaba Cloud Function Compute F# HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/f#/fc-custom-fsharp-http/src)
...
- Initialize the project: `s init fc-custom-fsharp-http -d fc-custom-fsharp-http`
