# Alibaba Cloud Function Compute PHP7.4 HTTP function case
...
- [:octocat: source](https://github.com/devsapp/start-fc/tree/master/custom-function/php74/fc-custom-php74-http/src)
...
- Initialize the project: `s init fc-custom-php74-http -d fc-custom-php74-http`
...
- Enter the project: `cd fc-custom-php74-http`
